...
class ImageListUpload extends Action implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            $fileUploader = $this->uploaderFactory->create(['fileId' => 'image_list']);
...
//          New folder when upload image if not exist
            $imagePath = 'simpleblog/blog/image_list/';
